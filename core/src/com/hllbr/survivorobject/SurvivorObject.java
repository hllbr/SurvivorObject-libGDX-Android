...
public class SurvivorObject extends ApplicationAdapter {
	...
	public void create () {
		...
		bird = new Texture("airship.png");
		bee1 = new Texture("sweet_tooth_cake.png");
		bee2 = new Texture("sweet_tooth_cake.png");
		bee3 = new Texture("sweet_tooth_cake.png");
		bee4 = new Texture("sweet_tooth_cake.png");
